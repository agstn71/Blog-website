            ...
            <div>
                ...
                <nav className='mt-12'>
                    <ul className='flex flex-col gap-7 text-2xl font-semibold '>
                        <Link href={"/"} onClick={() => shrefpenNav(false)}><li className='cursor-pointer'>Home</li></Link>
                        <Link href={"/blog"} onClick={() => setOpenNav(false)}><li className='cursor-pointer'>Blog</li></Link>
                        <Link href={"/about"} onClick={() => setOpenNav(false)}><li className='cursor-pointer' >About</li></Link>
                        {
                            user? <Button onClick={()=>{logoutHandler(), setOpenNav(false)}}>Logout</Button> : <Link href={'/signup'} onClick={() => setOpenNav(false)}><Button>Signup</Button></Link>
                        }
